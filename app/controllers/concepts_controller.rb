class ConceptsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @concept.save
        format.html { redirect_to concepts_path, notice: 'El concepto se añadió correctamente' }
  ...
  def destroy
    @concept.destroy
    respond_to do |format|
      format.html { redirect_to concepts_path, notice: 'El concepto fue eliminado' }
  ...
  private
    ...
    def concept_params
      params.require(:concept).permit(:nombre, :descripcion, :tipo, :clasificacion, :status)
    end
