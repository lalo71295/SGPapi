# == Schema Information
#
# Table name: expenses_attachments
#
...
class ExpensesAttachment < ApplicationRecord
  belongs_to :expense
  #has_attached_file :archivo, path: ":rails_root/archivos/:id/:style/:filename"
  has_attached_file :archivo, path: ":rails_root/archivos/viaticos/:expense_id/:filename"
  ...
  Paperclip.interpolates :expense_id do |attachment, style|
    attachment.instance.expense_id
  end
